...
<section class="section">
    <div class="container-fluid">
        <div class="section-header">
            <h1>Laporan Berjangka</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ url('/home') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Laporan Berjangka</div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="filterForm" action="{{ route('admin.report.berjangka') }}" method="GET" class="row">
                                <div class="form-group col-md-3">
                                    <label>Tanggal Mulai</label>
                                    <input type="date" class="form-control" name="tanggal_mulai" id="tanggal_mulai" value="{{ request('tanggal_mulai', date('Y-m-01')) }}">
                                </div>
                                
                                <div class="form-group col-md-3">
                                    <label>Tanggal Akhir</label>
                                    <input type="date" class="form-control" name="tanggal_akhir" id="tanggal_akhir" value="{{ request('tanggal_akhir', date('Y-m-t')) }}">
                                </div>
