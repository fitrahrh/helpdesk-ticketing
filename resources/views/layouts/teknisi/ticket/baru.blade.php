        ...
        <div class="col-md-9">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <h5><i class="fa fa-folder-open"></i> Tiket Baru</h5>
                </div>
            </div>
            <hr>
            <div class="card border-0 rounded-lg fade-in">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover" id="baru-tickets-table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>No Tiket</th>
...
<script>
    ...
    function initDataTable() {
        let table = $('#baru-tickets-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('teknisi.baru.data') }}",
            columns: [
